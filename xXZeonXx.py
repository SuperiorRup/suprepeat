...
async def status_task():
    while True:
       ...
       await asyncio.sleep(5)
       await client.change_presence(game=discord.Game(name=str(len(set(client.get_all_members())))+' members'))
       await asyncio.sleep(3)
       await client.change_presence(game=discord.Game(name=str(len(client.servers))+' servers'))
       await asyncio.sleep(3)
